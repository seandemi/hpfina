...
<script type="text/javascript" src="<?php echo base_url(); ?>js/baoxiaodan.js"></script>
...
<!--头部样式-->
  <?php
       ...
       $this->load->view('baoxiaodan/baoxiao/self/finish_ok',$info,$page);
  ?>
