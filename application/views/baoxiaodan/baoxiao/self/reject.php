...
<a href="<?=site_url("process/my_rejected")?>" style="display:none" id="my_rejected" ></a>
...
<div style="margin-left:60px;"><span style="padding-right:20px;">提交时间：<input id="time" style="width:80px;"></input></span><span style="padding-right:20px;">总金额 ：<input id="zongjine" style="width:80px;"></input></span><span style="margin-right:20px;display:none;">单据金额 ：<input id="danju" style="width:80px;"></input></span><span style="padding-right:20px;">报销单类型 ： <select id="leibie"  size="1" > 
				...
				</select></span><input type="button" onclick="my_rejected()" value="查询"></input></div>			
<div style="height:15px;clear: both;">	</div>
<div style="text-align:center;margin:0 auto;"><span id='head2'>被驳回的报销单列表</span></div>
<div class="titleleft">
...
<span id="headtittle"><input type="button" value="首页"  onclick="changepage_rejected(this)"/> &nbsp;<input type="button" value="上页" onclick="changepage_rejected(this)"/>&nbsp;<input type="button" value="下页"   onclick="changepage_rejected(this)"/>&nbsp;<input type="button" value="末页"  onclick="changepage_rejected(this)"/>&nbsp;</span>
</div>	
<div style="height:15px;clear: both;">	</div>	
</div>	
