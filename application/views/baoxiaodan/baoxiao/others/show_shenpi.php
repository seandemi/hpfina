...
<script type="text/javascript" src="<?php echo base_url(); ?>js/shenpi.js"></script>
...
<!--头部样式-->
  <?php
       ...
       if($basic['number']>0){
       $this->load->view('baoxiaodan/baoxiao/others/show_shenping',$basic);
       }
       else {
