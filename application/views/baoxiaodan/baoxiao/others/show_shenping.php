...
<table id="baoxiao"  align="center" > 
	...
	<tr>  
			...
			<td  align="left"><?php echo $baoxiaoinfo[0]['yuangongbianhao'];?></td> 
			<td  align="right"><strong>员工姓名:</strong></td> 
			<td  align="left"><?php echo $baoxiaoinfo[0]['xingming'];?></td> 
...
<div >
	 <span id="yijian" > <label> 审批意见：</label>
     <textarea  id="shenpiyijian" style="color:#028ad4"></textarea>
    </span>&nbsp;&nbsp;    
     <span>
        <a  href="<?=site_url("manage/shenpi")?>"  style="display:none;" id="mainpage"></a>
     <a  href="<?=site_url("operate/agree/{$baoxiaoinfo[0]['baoxiaobianhao']}")?>"  style="display:none;" id="agree"></a>
     <a  href="<?=site_url("operate/reject/{$baoxiaoinfo[0]['baoxiaobianhao']}")?>"  style="display:none;" id="reject"></a>
     
      <a  type="button" style="font-size:18px;"  onclick="baoxiaoshenpi(this)" class="btn1_mouseout" onmouseover="this.className='btn1_mouseover'">同意</a>&nbsp;&nbsp;
     <a  type="button" style="font-size:18px;"  onclick="baoxiaoshenpi(this)"  class="btn1_mouseout" onmouseover="this.className='btn1_mouseover'" >驳回</a>
     </span>
</div>
</div>
</div>
