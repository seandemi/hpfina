...
<script type="text/javascript" src="<?php echo base_url(); ?>js/check_info.js"></script>
<script language="javascript" src="<?php echo base_url(); ?>js/date/My97DatePicker/WdatePicker.js"></script> 
...
<!--头部样式-->
  <?php
       ...
       $this->load->view('user/detail',$basic);
  ?>
