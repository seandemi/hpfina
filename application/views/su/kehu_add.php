...
<div id="page-heading"><h1>添加客户</h1></div>
...
<tr>
	...
	<?php
	    ...
	    echo form_open('su/kehu/doadd',$attributes); 
	?>
		<table  border="0" cellpadding="0" cellspacing="0"  id="id-form">
		<tr>
			<th valign="top">客户编号:</th>
			<td><input check="<?=site_url("su/kehu/checkadd/")?>" type="text" name="kehuno" id="kehuno"  class="inp-form" /></td>
			<td>
		...
		<tr>
			...
			<td><input type="text" name="kehuname" id="kehuname" class="inp-form" /></td>
			<td>
		...
		<tr>
			...
			<td><input type="text" name="kaihuyinhang" id="kaihuyinhang" class="inp-form" /></td>
			<td>
		...
		<tr>
			...
			<td><input type="text" name="kaihuming" id="kaihuming" class="inp-form" /></td>
			<td>
		...
		<tr>
			...
			<td><input type="text" name="zhanghao" id="zhanghao" class="inp-form" /></td>
			<td>
		...
		<tr>
			<th valign="top">税号:</th>
			<td><input type="text" name="shuihao" id="shuihao" class="inp-form" /></td>
			<td>
		...
		<tr>
			<th valign="top">地址:</th>
			<td><input type="text" name="dizhi" id="dizhi" class="inp-form" /></td>
			<td>
		...
		<tr>
			<th valign="top">电话:</th>
			<td><input type="text" name="tel" id="tel" class="inp-form" /></td>
			<td>
		...
		<tr>
			<th valign="top">传真:</th>
			<td><input type="text" name="chuanzhen" id="chuanzhen" class="inp-form" /></td>
			<td>
		...
		<tr>
			...
			<td><input type="text" name="lianxiren" id="lianxiren" class="inp-form" /></td>
			<td>
