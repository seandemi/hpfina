...
<div class="nav-outer"> 
		...
		<div id="nav-right">
			...
			<div class="showhide-account"><img src="<?php echo base_url(); ?>img/su/shared/nav/nav_myaccount.gif" width="93" height="14" alt="" /></div>
			<div class="nav-divider">&nbsp;</div>
			<a href="" id="logout"><img src="<?php echo base_url(); ?>img/su/shared/nav/nav_logout.gif" width="64" height="14" alt="" /></a>
			<div class="clear">&nbsp;</div>
		...
		<!--[if lte IE 6]><table><tr><td><![endif]-->
			    <ul id="pt2">
                    <li>
                        ...
                        <a href="/product.php?t=1">部门管理</a>
                        <img class="corner_inset_right1" alt="" src="<?php echo base_url(); ?>img/su/corner_inset_right.png"/>
                    </li>
                    <li><a href="/product.php?t=33">员工账户管理</a></li>
					<li><a href="/product.php?t=38">审批时限管理</a></li>
					<li><a href="/product.php?t=38">审批权限设置</a></li>
					<li><a href="/product.php?t=38">报销路径设置</a></li>
                    <li class="last">
