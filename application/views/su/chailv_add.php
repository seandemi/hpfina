...
<tr>
	...
	<?php
	    ...
	    echo form_open('su/chailv/doadd',$attributes); 
	?>	
		<table  border="0" cellpadding="0" cellspacing="0"  id="id-form">
				<tr>
		<th valign="top">员工级别:</th>
		<td>	
		<select  name="zhiwei" id="spb1" class="form_3">
		...
		<tr>
			...
			<td><input type="text" value = "0.00" name="jine1" id="bumenno" class="inp-form" /></td>
			<td>
		...
		<tr>
			...
			<td><input type="text"  value = "0.00" name="jine2" id="bumenname" class="inp-form" /></td>
			<td>
		...
		<tr>
			...
			<td><input type="text" name="jine3" id="jine3" value = "0.00" class="inp-form" /></td>
			<td>
