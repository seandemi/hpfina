...
<div id="page-heading"><h1>添加部门</h1></div>
...
<tr>
	...
	<?php
	    ...
	    echo form_open('su/bumen/doadd',$attributes); 
	?>	
		<table  border="0" cellpadding="0" cellspacing="0"  id="id-form">
		<tr>
			<th valign="top">部门编号:</th>
			<td><input type="text" check="<?=site_url("su/bumen/checkbianhao/")?>" name="bumenno" id="bumenno" class="inp-form" /></td>
			<td>
			<div id="error-left1" class="error-left" style="display:none;"></div>
			<div id="error-inner1" class="error-inner" style="display:none;">输入必须为1-15位数字与字母的组合.</div>
			</td>
		</tr>
		<tr>
			<th valign="top">部门名称:</th>
			<td><input type="text" check="<?=site_url("su/bumen/checkname/")?>" name="bumenname" id="bumenname" class="inp-form" /></td>
			<td>
		...
		<tr>
			...
			<td><input type="text" name="bumenattr" id="bumenattr" class="inp-form" /></td>
			<td>
		...
		<tr>
			...
			<td><input type="text" name="bumencate" id="bumencate" class="inp-form" /></td>
			<td>
...
<script type="text/javascript">
    ...
    $("#bumenno").blur(function(){
        ...
        if(reg.test(value)){
        	...
        	$('#error-left1').show();
        	$('#error-inner1').show();
        	$('#error-inner1').html("输入必须为1-15位数字和字母的组合");
        	check1 = false;
        	return false;
        }
		$.ajax({
