...
<tr>
	...
	<td>
		...
		<div id="step-holder">
			...
			<div class="step-light-left">报销路径2</div>
			<div class="step-light-right">&nbsp;</div>
			<div class="step-no-off">3</div>
			<div class="step-light-left">报销路径3</div>
			<div class="step-light-right">&nbsp;</div>
			<div class="step-no-off">4</div>
			<div class="step-light-left">报销路径4</div>
			<div class="step-light-right">&nbsp;</div>
	...
	<?php
	    ...
	    echo form_open('su/yuangong/addbaoxiao',$attributes);
	?>
	<input type="hidden" name="yuangongbianhao" value="<?php echo $yuangongno;?>" />
	<input type="hidden" name="baoxiaonum" value="1" />
		<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
		<tr>
			<th valign="top">报销金额下限:</th>
			<td><input type="text" id="xiaxian" name="xiaxian" class="form_2" value="0.00" readonly="readonly" /></td>
		</tr>
		<tr>
	...
	<tr>
		<th>&nbsp;</th>
		<td valign="top">
			<input type="submit"  onclick="return true" class="form-submit" />
<!--			<input type="button" value="" class="form-complete"  />-->
			<a class="form-complete" href="<?=site_url('su/yuangong/index')?>"></a>
		</td>
		<td></td>
	</tr>
	</table>
...
<a href="<?=site_url("su/yuangong/zw2ren")?>" style="display:none" id="zhiweixuanzhe" ></a>
<!--  end content-outer -->
<div class="clear">&nbsp;</div>
