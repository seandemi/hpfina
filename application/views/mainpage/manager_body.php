...
<div style="height:15px;clear: both;"></div> 
	<div><span id='info_table'>被驳回的报销单列表</span></div>			
					...
					<td>	<a href="<?=site_url("info/reject/{$data_pro['baoxiaobianhao']}/{$data_pro['baoxiaoleixing']}")?>">查看</a> </td>								
					</tr>
					<?php endforeach;}?>
					</tbody> 
					</table> 		
...
<div class="leftcontent3" style="margin-top: 0px;  overflow: hidden;">	
<div style="height:15px;clear: both;"></div> 
	<div><span id='info_table'>等待您审批的报销单</span></div>			
				<table id="rounded-corner" > 
					<thead> 
					<tr> 
                    <th scope="col" class="rounded-company">员工姓名</th> 
					<th scope="col" class="rounded-q1">提交时间</th> 
					<th scope="col" class="rounded-q2">总金额</th> 
					<th scope="col" class="rounded-q3">报销类型</th> 
					...
					<tfoot> 
					<tr> 
					<td colspan="4" class="rounded-foot-left"><em><a href="<?=site_url("manage/shenpi")?>" style="float:right;">查看更多...</a></em></td> 
					<td class="rounded-foot-right">&nbsp;</td> 
					</tr> 
					</tfoot> 
					<tbody> 
